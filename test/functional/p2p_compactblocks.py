...
# TestP2PConn: A peer we use to send messages to usdecoind, and store responses.
...
class CompactBlocksTest(UsdecoinTestFramework):
    ...
    # This test actually causes usdecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that usdecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for usdecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # usdecoind will not send blocktxn responses for blocks whose height is
