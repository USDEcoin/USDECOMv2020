...
"""Verify that starting usdecoin with -h works as expected."""
import subprocess

from test_framework.test_framework import UsdecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(UsdecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start usdecoin with -h for help text")
        ...
        self.log.info("Start usdecoin with -version for version information")
        ...
        self.log.info("Start usdecoind with -fakearg to make sure it does not start")
