...
class FullBlockTest(UsdecoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure usdecoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure usdecoind isn't accepting b28
        ...
        # usdecoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the usdecoin code has custom code which does so);
