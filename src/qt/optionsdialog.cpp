    ...
    mapper(0)
{
    ...
    ui->usdecoinAtStartup->setToolTip(ui->usdecoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->usdecoinAtStartup->setText(ui->usdecoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openUsdecoinConfButton->setToolTip(ui->openUsdecoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new UsdecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->usdecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openUsdecoinConfButton_clicked()
{
