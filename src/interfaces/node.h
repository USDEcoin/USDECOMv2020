...
#ifndef USDECOIN_INTERFACES_NODE_H
#define USDECOIN_INTERFACES_NODE_H
...
//! Top-level interface for a usdecoin node (usdecoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // USDECOIN_INTERFACES_NODE_H
