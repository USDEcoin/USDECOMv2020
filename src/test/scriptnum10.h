...
#ifndef USDECOIN_TEST_SCRIPTNUM10_H
#define USDECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Usdecoin Core 0.10.0, for cross-comparison.
 */
public:
