...
#ifndef USDECOIN_WALLET_WALLET_H
#define USDECOIN_WALLET_WALLET_H
...
public:
     ...
     * on this usdecoin node, and set to 0 for transactions that were created
...
#endif // USDECOIN_WALLET_WALLET_H
