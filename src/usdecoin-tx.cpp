...
static void SetupUsdecoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf("%s usdecoin-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  usdecoin-tx [options] <hex-tx> [commands]  Update hex-encoded usdecoin transaction\n" +
              "  usdecoin-tx [options] -create [commands]   Create hex-encoded usdecoin transaction\n" +
              "\n";
