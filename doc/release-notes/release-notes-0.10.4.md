Usdecoin Core version 0.10.4 is now available from:

  <https://usdecoin.org/bin/usdecoin-core-0.10.4/>
...
- #6953 `43c2789` Split usdecoin-tx into its own package
- #6953 `dfe0d4d` Include usdecoin-tx binary on Debian/Ubuntu
