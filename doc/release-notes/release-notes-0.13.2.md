Usdecoin Core version 0.13.2 is now available from:

  <https://usdecoin.org/bin/usdecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update usdecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow usdecoin-tx to create v2 transactions (USDEdrak)
