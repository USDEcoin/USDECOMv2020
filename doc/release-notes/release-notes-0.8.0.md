Usdecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/usdecoin/files/Usdecoin/usdecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Usdecoin
...
New/changed settings (command-line or usdecoin.conf file)
--------------------------------------------------------
