Usdecoin Core version 0.9.2.1 is now available from:

  https://usdecoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 USDE to 0.01 USDE
...
- Fix "Start usdecoin on system login"
