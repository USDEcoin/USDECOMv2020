Usdecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/usdecoin/files/Usdecoin/usdecoin-0.5.4/
...
http://gitorious.org/usdecoin/usdecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Usdecoin-Qt notifications under Growl 1.3.
Increase required age of Usdecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxUsdecoin properly when installing Usdecoin-Qt over it. (Windows)
