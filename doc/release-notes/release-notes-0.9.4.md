Usdecoin Core version 0.9.4 is now available from:

  https://usdecoin.org/bin/0.9.4/
...
this update is incompatible with the Usdecoin system and could lead to consensus
forks.

Usdecoin Core released binaries from https://usdecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~usdecoin/+archive/ubuntu/usdecoin
- A third-party or self-compiled Usdecoin Core

upgrade to Usdecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
