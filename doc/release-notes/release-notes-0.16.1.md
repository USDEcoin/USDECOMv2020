Usdecoin Core version 0.16.1 is now available from:

  <https://usdecoincore.org/bin/usdecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting usdecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure usdecoind processes are cleaned up when tests end (sdaftuar)
